    ...
    <body>
        <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
          ...
          <div class="main-content" id="panel">
            ...
            <div class="container">
                <form method="POST" action="createquestion/{{ $id }}">

                    @csrf
                    <div class="form-group">
                      <label for="formGroupExampleInput">Question</label>
                      <input type="text" class="form-control" name="question" id="question" placeholder="Ouestion" required>
                    </div>
                    <div class="form-group">
                      <label for="formGroupExampleInput2">Correct Choice</label>
                      <input type="text"  class="form-control border border-success" name="choice1" id="choice1" placeholder="Correct Choice" required>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Wrong Choice</label>
                        <input type="text"  class="form-control border border border-danger" name="choice2" id="choice2" placeholder="Wrong Choice" required>
                      </div>
                      <div class="form-group">
                        <label for="formGroupExampleInput2">Wrong Choice</label>
                        <input type="text"  class="form-control border border border-danger" name="choice3" id="choice3" placeholder="Wrong Choice" >
                      </div>
                      <div class="form-group">
                        <label for="formGroupExampleInput2">Wrong Choice</label>
                        <input type="text"  class="form-control border border border-danger" name="choice4" id="choice4" placeholder="Wrong Choice" >
                      </div>
                      <div class="form-group">
                        <input  value="add more" type="submit"  class="btn btn-primary" />
                      </div>

                  </form>
                  <div>
                      <a href="/teacher/assignments" class="btn btn-primary">Finish</a>
                  </div>
            </div>
          </div>
