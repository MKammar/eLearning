                  ...
                  <table class="table align-items-center table-flush" id="myTable">
                    <thead class="thead-light">
                      <tr>
                        ...
                        <th scope="col" class="sort" data-sort="name">Experience Title</th>
                        <th scope="col" class="sort" data-sort="budget">Experience Description</th>
                        <th scope="col" class="sort" data-sort="status">Experience Start</th>
                        <th scope="col" class="sort" data-sort="status">Experience End</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <th scope="row">
                                ...
                                <span class="name mb-0 text-sm">{{ $exp->expTitle }}</span>

                          </th>
                            <td class="budget">
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{ $exp->expDes }}</span>
                                  </span>
                            </td>
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{ $exp->expStart }}</span>
                                  </span>
                            </td>
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{ $exp->expEnd }}</span>
                                  </span>
                            </td>

                            <td>
                                <a href="{{ url('/teacher/editworkexperience/'.  $exp->exp_id ) }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                <a href="{{ url('/teacher/workexperience/'.  $exp->exp_id ) }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                          </tr>
                        @endforeach
                ...
                <form method="post" action="/profile/addworkexperience">
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                                ...
                                <input type="Date" name="expStart" class="form-control form-control-sm mr-1"  placeholder="Experience Start Date">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">
                                <label class="sr-only">Experience End Date</label>
                                <input type="Date" name="expEnd" class="form-control form-control-sm mr-1"  placeholder="Experience End Date">
                        </div>
                    </div>
                    <div>
