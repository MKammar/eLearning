              ...
              <div class="header-body">
                <div class="row align-items-center py-4">
                  <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Assignment : {{ $assg->title }}</h6><br>
                    <h4 class="text-white d-inline-block">Student : {{ $student->firstName }} {{ $student->lastName }}</h4>
                ...
                <div class="col">
                  <div class="card">
                    ...
                    <div class="card-header border-0">
                      <h3 class="mb-0">{{ $student->firstName }} garde is {{ $totalGrade }}/100</h3>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}" value="{{ $question->choice1 }}"  @if($question->answer == $question->choice1) checked="checked" @endif>
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice1 }}
                                </label>
                              </div>
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}"  value="{{ $question->choice2 }}"  @if($question->answer == $question->choice2) checked="checked" @endif>
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice2 }}
                                </label>
                              </div>
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}" value="{{ $question->choice3 }}"  @if($question->answer == $question->choice3) checked="checked" @endif>
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice3 }}
                                </label>
                              </div>
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}"  value="{{ $question->choice4 }}"  @if($question->answer == $question->choice4) checked="checked" @endif>
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice4 }}
                                </label>
                              </div>
                              ...
                              <div class="ml-auto">
                                ...
                                @else
                                <p class="col-3 text-center text-danger border border-danger">
                                    <span>
