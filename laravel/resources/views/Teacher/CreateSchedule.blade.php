...
<form method="POST" action="/teacher/addschedule/{{$id}}">
@csrf

<div class="form-group row ">
<label for="" class="col-2 col-form-label">Day</label>
      <select id="inputState" name="day" class="form-control col-6 ">
...
<div class="form-group row">
  <label for="example-time-input" class="col-2 col-form-label">start session</label>
  <div class="col-6">
    <input class="form-control" type="time"  name="start">
  </div>
</div>
<div class="form-group row">
  <label for="example-time-input" class="col-2 col-form-label">end session</label>
  <div class="col-6">
...
<div>
   <a href="/teacher/schedule" class="btn btn-primary">Finish</a>
 </div>
</div>
<x-alert />
</div>
