...
<body>
  ...
  <main>
    ...
    <div class="calendar">
      ...
      @foreach($sc_students as $sc_t)
      @foreach($users as $user)
      <div class="calendar__week">
        <div class="calendar__day ">
        @if($sc_t->day=="Monday" && $sc_t->t_id==$user->id)
          {{$sc_t->start_time}}
          {{$sc_t->end_time}}
        ...
        <div class="calendar__day ">
        @if($sc_t->day=="Tuesday" && $sc_t->t_id==$user->id)
          {{$sc_t->start_time}}
          {{$sc_t->end_time}}
          {{$user->firstName}}  {{$user->lastName}}
        @endif
        ...
        <div class="calendar__day ">
        @if($sc_t->day=="Wednesday" &&  $sc_t->t_id==$user->id)
          {{$sc_t->start_time}}
          {{$sc_t->end_time}}
          {{$user->firstName}}  {{$user->lastName}}
        @endif
        ...
        <div class="calendar__day ">
        @if($sc_t->day=="Thursday" && $sc_t->t_id==$user->id)
          {{$sc_t->start_time}}
          {{$sc_t->end_time}}
          {{$user->firstName}}  {{$user->lastName}}
        @endif
        ...
        <div class="calendar__day ">
        @if($sc_t->day=="Friday"  && $sc_t->t_id==$user->id)
          {{$sc_t->start_time}}
          {{$sc_t->end_time}}
          {{$user->firstName}}  {{$user->lastName}}
        @endif
        ...
        <div class="calendar__day ">
        @if($sc_t->day==" Saturday" && $sc_t->t_id==$user->id)
          {{$sc_t->start_time}}
          {{$sc_t->end_time}}
          {{$user->firstName}}  {{$user->lastName}}
        @endif
