      ...
      <div class="main-content" id="panel">
        ...
        <div class="row">
            <div class="col align-items-center">
                <h1 class="col-sm-4 offset-sm-4 text-center mediatitle">Teachers</h1>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col">
                ...
                {{-- <p>{{ $teacher->firstName }}</p> --}}
                        ...
                        <div class="media" id="media">
                            <img src="{{ asset('upload/images/'.$teacher->imageUser)}}" alt="teacher">
                            <div class="media-body" id="media-body">
                                <h2 class="mt-0"> {{ $teacher->firstName }}</h2>
                                <p>My Name is {{ $teacher->firstName  }} {{ $teacher->lastName }},
                                I'm a {{ $teacher->subject }} teacher and  I studied at {{ $teacher->university }}</p>
                            </div>
                            <a class="mr-auto btn btn-link" id="btnmedia" href="{{ url('/teacherdetails/'. $teacher->id) }}">More info</a>
                        </div>
