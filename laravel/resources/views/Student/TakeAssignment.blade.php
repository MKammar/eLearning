            ...
            <div class="row">
                <div class="col">
                  <div class="card">
                    ...
                    <form method="POST" action="/student/SubmitAssignment/{{ $assg->a_id }}">
                        @csrf
                    <?php  $i=1 ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}" value="{{ $question->choice1 }}" >
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice1 }}
                                </label>
                              </div>
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}"  value="{{ $question->choice2 }}" >
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice2 }}
                                </label>
                              </div>
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}" value="{{ $question->choice3 }}" >
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice3 }}
                                </label>
                              </div>
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="question-{{ $question->q_id }}" id="exampleRadios-{{ $question->q_id }}"  value="{{ $question->choice4 }}" >
                                <label class="form-check-label" for="exampleRadios1">
                                  {{ $question->choice4 }}
                                </label>
                              </div>
