  ...
  <div class="header-body">
    <div class="row align-items-center py-4">
      <div class="col-lg-6 col-7">
        <h6 class="h2 text-white d-inline-block mb-0">Activity List </h6>
    ...
    <div class="table-responsive">
      <table class="table align-items-center table-flush" id="myTable">
        <thead class="thead-light">
          <tr>
            <th scope="col" class="sort" data-sort="name">Teacher firstname</th>
            <th scope="col" class="sort" data-sort="budget">Teacher Lastname</th>
            ...
            <th scope="col" class="sort" data-sort="status">MeetingDate</th>
            <th scope="col" class="sort" data-sort="status">MeetingTime</th>
            <th scope="col" class="sort" data-sort="status">Response</th>
          </tr>
        </thead>
        <tbody class="list">
                        @foreach ($reqs as $req)
                        ...
                        <tr>
                            <td class="budget">
                                <span class="badge badge-dot mr-4">
                                    ...
                                    <span class="status">{{$user->firstName}}</span>
                                  </span>
                            </td>
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{$user->lastName}}</span>
                                  </span>
                            </td>
                        ...
                        @endforeach
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{$req->subject}}</span>
                                  </span>
                            </td>
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{$req->teachingLang}}</span>
                                  </span>
                            </td>
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{$req->teachingGrade}}</span>
                                  </span>
                            </td>
                            ...
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">not set yet</span>
                                  </span>
                            </td>
                            @else
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{$req->meetingDate}}</span>
                                  </span>
                            </td>
                            @endif
                          ...
                          @else
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">{{$req->meetingTime}}</span>
                                  </span>
                            </td>
                            @endif
                            @if($req->Response==1)
                            ...
                            <td>
                                <span class="badge badge-dot mr-4">
                                    <i class="bg-warning"></i>
                                    <span class="status">Waiting teacher acceptance </span>
                                  </span>
                            </td>
                            @endif

                            <td>
                                <a href="{{ url('/student/activity/delete/'.$req->r_id ) }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                          </tr>
                        @endforeach
                    </tbody>
