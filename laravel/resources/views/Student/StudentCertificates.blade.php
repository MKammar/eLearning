        ...
        <div class="row">
            ...
            <div class="col">
                ...
                @foreach($users as $user)
                    @if ($user->id == $cert->t_id)
                    <div class="media" id="media">
                        <img src="{{ asset('upload/images/'.$user->imageUser)}}" alt="teacher">
                        <div class="media-body" id="media-body">
                            <h2 class="mt-0">Teacher: {{ $user->firstName }} {{ $user->lastName }}</h2>
                            <p>Congrats! You can view  Your certificate</p>
                        </div>
                        <a class="mr-auto btn btn-link" id="btnmedia" href="{{ url('/ViewCertificate/'. $cert->certificate_id) }}">View</a>
                    </div>
                    @endif
